...
module.exports.PublishCustomerEvent = async (payload) => {
  ...
  await axios.post(`${CUSTOMER_SERVICE_URL}/app-events`, { payload })
}

module.exports.PublishShoppingEvent = async (payload) => {
  // perform some operations
  await axios.post(`${SHOPPING_SERVICE_URL}/app-events`, { payload })
}
...
module.exports.PublishMessage = async (channel, bindingKey, message) => {
  try {
    ...
    console.log(`Send message to ${bindingKey} successfully!!\ncontent: ${JSON.stringify(message)}`)
  } catch (error) {
    throw error
  }
}
...
module.exports.SubscribeMessage = async (channel, bindingKey, service) => {
  try {
